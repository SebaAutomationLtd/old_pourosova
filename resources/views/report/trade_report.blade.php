...
<section class="content">
    <div class="container-fluid">
      <div class="row mb-2" style="margin-top: 20px;">
        <div class="col-sm-6">
            <h5>ট্রেড লাইসেন্স রিপোর্ট</h5> 
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">হোম</a></li>
                <li class="breadcrumb-item active">ট্রেড লাইসেন্স রিপোর্ট</li>
            </ol>
        </div>
    </div>
    @php
     $total = DB::table('due_trade_licenses')->count()
    @endphp
   <div class="row">
   <div class="col-md-12">
        <div class="card main-chart mt-4">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                 <form action="{{ URL::to('/filter-data_trade_report')}}" method="get">
                                  @csrf
                                <div class="row">
