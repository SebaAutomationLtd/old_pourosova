  ...
  <section class="content-header">
    ...
    <div class="container">
    	<div class="row">
    	  ...
    	  @if($view->status == '0')
    	  	<a style="margin-top: 10px; margin-left: 18px;" href="{{URL::to('/approved-orphan_sonod/'.$view->id)}}" class="btn btn-success">Approved</a>
    	  @else
    	  <a style="margin-top: 10px; margin-left: 18px;" href="{{URL::to('/inactived-orphan_sonod/'.$view->id)}}" class="btn btn-danger">Pending</a>
