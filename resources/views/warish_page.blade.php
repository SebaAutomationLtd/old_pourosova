   ...
   <div class="dashboard-body">
	 ...
	 @else
	  <div class="content-header">
	    ...
	    <div class="content py-5">
	    	আপনার ওয়ারিশ সনদটি ডাউনলোড করতে <a style="cursor: pointer"  class="warish_pdf" id="warish_pdf"><span style="color: blue;">এখানে ক্লিক</span></a> করুন.করুন
	    </div>
	 @endif
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
 ...
 <script>
   $(document).ready(function($){
   	  $(document).on('click', '.warish_pdf', function(e){
   	  	 e.preventDefault();
   	  	 $.ajax({
                    url: "{{  url('/pdf-warish') }}",
