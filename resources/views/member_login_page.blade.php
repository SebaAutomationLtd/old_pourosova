...
<head lang="en">
    ...
    <link rel="stylesheet" href="{{asset('user-login/css/all.min.css')}}" />
    <script src="{{asset('user-login/js/jquery-3.5.1.slim.min.js')}}"></script>
    <script src="{{asset('user-login/js/custom.js')}}"></script>
    ...
    <div class="wrapper">
        <div class="login-page">
            <div class="form">
                ...
                <form class="login-form" method="post" action="{{URL::to('/member-login')}}" method="post">
                  @csrf
                    <input class="bn-font" type="text" name="user_id" placeholder="কার্ড নম্বর"
