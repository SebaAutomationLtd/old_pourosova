    ...
    <div class="col-lg-9 mt-4 mt-lg-0">
        <div class="dashboard-body">
            ...
            @else
                ...
                <div class="content py-5">
                    আপনার নাগরিক সনদটি ডাউনলোড করতে <a style="cursor: pointer" class="nagorik_pdf" id="nagorik_pdf"><span
                            style="color: blue;">এখানে ক্লিক</span></a> করুন.
                </div>
            @endif
