            ...
            <div class="row dashboard-body">
                <div class="col-md-12">
                    <div class="website-form form-group">
                        ...
                        <form  method="post" action="{{route('sanad.apply')}}" enctype="multipart/form-data" style="margin-top: 20px">
                            @csrf 
                            <h5><u>আবেদনকারীর তথ্য</u> </h5>
                            <div class="row ">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4" id="father_name">
                                    ...
                                    <input type="text" name="father_name" value="" class="form-control gurdian_status" id="father_name" autocomplete="off" placeholder="পিতার নাম " required>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <label for="nid_birth" class="col-form-label">
                                        ...
                                        <span style="color: red">*</span></label>
                                    <input type="number" name="nid" value="" class="form-control birth_nid" id="nid_birth" autocomplete="off" placeholder="এনআইডি নম্বর" required>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-12">
                                    <label for="address" class="col-form-label">ঠিকানা <span style="color: red">*</span></label></label> 
                                    <textarea name="address" id="address" cols="10" rows="10" class="form-control" required  placeholder="ঠিকানা"></textarea>
                                </div>
                                <div class="col-sm-4">
                                    <label for="image" class="col-form-label">ছবি (ঐচ্ছিক)</label>
                                    <input type="file" name="image" value="" class="form-control" id="image" placeholder="ছবি" accept="image" >
                                </div>
