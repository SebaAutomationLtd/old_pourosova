              ...
              <div class="container col-lg-4"> 
                ...
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="settings"><br><br>
                    <form class="form-horizontal" action="{{route('update.post_office')}}" method="post" class="needs-validation">
                    @csrf  
                    <input type="hidden" name="post_office_id" value="{{$edit->id}}">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="post_code_id" id="" class="form-control @error('post_code_id') is-invalid @enderror">
                                ...
                                <option value="{{$row->id}}" <?php if($row->id == $edit->post_code_id){echo "selected";} ?>>{{$row->post_code}}</option>
                                @endforeach
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control @error('post_office') is-invalid @enderror" name="post_office" placeholder="ডাকঘর" value="{{$edit->post_office}}">
