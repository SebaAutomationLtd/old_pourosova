                    ...
                    <form action="{{ route('department.unoEdit') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="">
                            <div class="form-group">
                                <label for="">নাম</label>
                                <input required name="name" value="{{ $uno->name }}" type="text" class="form-control"
                                    placeholder="">
                                <input name="department" type="hidden" value="admin" class="form-control" placeholder="">
                                <input name="id" type="hidden" value="{{ $uno->id }}" class="form-control"
                                    placeholder="">
                                <input name="type" type="hidden" value="head" class="form-control" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="">পদবী</label>
                                <input required name="designation" value="{{ $uno->designation }}" type="text"
                                    class="form-control" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="">ইমেইল</label>
                                <input name="email" type="tel" value="{{ $uno->email }}" class="form-control"
                                    placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="">মোবাইল নং</label>
                                <input name="contact" type="tel" value="{{ $uno->contact }}" class="form-control"
                                    placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="">টেলিফোন</label>
                                <input name="phone" type="tel" value="{{ $uno->phone }}" class="form-control"
                                    placeholder="">
                            </div>
