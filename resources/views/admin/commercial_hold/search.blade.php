            ...
            <div class="col-md-12">
                <div class="card main-chart mt-4">
                    <div class="card-header panel-tabs">
                        <h5>বানিজ্যিক হোল্ডিং নিবন্ধন টেবিল 
                            <form action="{{ URL::to('exportpdfcomdata') }}" method="get" name="getformdata">
                                <input type="hidden" name="wardid" value="{{$wardid}}">
                                <input type="hidden" name="nid" value="{{$nid}}">
                                <input type="hidden" name="mobile" value="{{$mobile}}">
                                <button type="submit" class="btn btn-primary float-right"><i class="fas fa-download"></i> Download</button>
                            </form> 
                        </h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <form action="{{ URL::to('commercial-hold-filter') }}" method="get" name="getformdata">
                                <div class="row">
                                    <div class="col-lg-5 col-md-7 col-sm-10">
                                        <div class="input-group">
                                            @php
                                            $wardid= DB::table('wards')->where('id',$wardid)->first();
                                            @endphp
                                            <div class="input-group-prepend">
                                                <select style="border-radius: .25rem 0 0 .25rem;" name="wardid" id=""
                                                        class="form-control form-control-sm">
                                                    <option value="{{$wardid->id}}">{{$wardid->ward_no}}</option>
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="mobile"
                                                   placeholder="মোবাইল নং" value="{{$mobile}}">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-2 font-weight-bold text-primary col-sm-4">মোট ইউজার : {{ count($all) }}
                            </div>
