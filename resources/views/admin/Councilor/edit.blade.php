        ...
        <div class="card main-chart mt-4">
         ...
         <div class="card-body">
           <div class="row">
             ...
             <div class="col-md-6">
             <form action="{{URL::to('/update-councilor/'.$edit->id)}}" method="post" enctype="multipart/form-data">
           		@csrf
             ...
             <div class="col-md-6">
             	<div class="form-group">
              	...
              	<input type="text" name="ward_no" id="ward_no" class="form-control" placeholder="ওয়ার্ড নং" value="{{$edit->ward_no}}">
              </div>
             </div>
