        ...
        <div class="card main-chart mt-4">
         ...
         <div class="card-body">
           <div class="row">
             ...
             <div class="col-md-5">
             <form action="{{URL::to('/update-link/'.$edit->id)}}" method="post" enctype="multipart/form-data">
           		@csrf
             	<div class="form-group">
		           	<label for="title">Title</label>
		           	<input type="text" id="title" name="title" class="form-control" placeholder="Title" value="{{$edit->title}}">
		        </div> 
             </div>
             ...
             <div class="col-md-7">
             	<div class="form-group">
		           	...
		           	<input type="text" id="url" name="url" class="form-control" placeholder="URL" value="{{$edit->url}}">
		        </div> 
             </div>
             ...
             <div class="col-md-12">
                <div class="form-group">
                 ...
                 <input type="checkbox" id="left_sidebar" name="left_sidebar" value="1" <?php if($edit->left_sidebar == 1){echo "checked";} ?>>
                 <label for="left_sidebar" style="cursor: pointer;">Left Sidebar</label><br>

                 <input type="checkbox" id="right_sidebar" name="right_sidebar" value="1"  <?php if($edit->right_sidebar == 1){echo "checked";} ?>>
