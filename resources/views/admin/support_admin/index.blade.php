                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($users as $key => $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $business = DB::select('select * from business_holds where added_by="' . $row->user_id . '" and created_at like "' . date('Y-m-d') . '%"');
                                                            
                                                            $general = DB::select('select * from general_members where added_by="' . $row->user_id . '" and created_at like "' . date('Y-m-d') . '%"');
                                                        @endphp
                                                        {{ count($general) }}
                                                    </td>
                                                    <td>
