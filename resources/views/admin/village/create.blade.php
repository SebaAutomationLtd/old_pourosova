            ...
            <div class="container col-lg-4">
              ...
              <div class="tab-content">
                ...
                <div class="active tab-pane" id="settings"><br><br>
                  <form class="needs-validation" action="{{route('store.village')}}" method="post" name="form">
                   @csrf                   
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control @error('village_name') is-invalid @enderror" name="village_name" placeholder="Name" value="{{ old('village_name') }}">
                        @error('village_name')
