                                    ...
                                    <table
                                        ...
                                        @foreach ($users as $key => $row)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $business = DB::select('select * from business_holds where activate_by="' . $row->id . '" and created_at like "' . date('Y-m-d') . '%"');

                                                        $general = DB::select('select * from general_members where activate_by="' . $row->id . '" and created_at like "' . date('Y-m-d') . '%"')
                                                    @endphp
                                                    {{ count($general) }}
                                                </td>
                                                <td>
