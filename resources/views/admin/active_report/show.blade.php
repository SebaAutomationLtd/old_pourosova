    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row mb-2" style="margin-top: 20px;">
                <div class="col-sm-6">
                    <h5>সাপোর্ট এডমিনের একটিভেশন তথ্য</h5>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">হোম</a></li>
                        <li class="breadcrumb-item active">সাপোর্ট এডমিনের একটিভেশন তথ্য</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a data-toggle="tooltip" title="তথ্যগুলো দেখুন"
                                               href="{{ route('active_report_gen_view', [$row->date, $user->user_id]) }}"
                            ...
                            <table class="table table-striped table-bordered datatable responsive nowrap table-hover"
                                ...
                                @foreach ($business as $key => $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a data-toggle="tooltip" title="তথ্যগুলো দেখুন"
                                               href="{{ route('active_report_business_view', [$row->date, $user->user_id]) }}"
                                               class="btn btn-primary btn-sm "><i class=" far fa-eye"></i> বিস্তারিত
                                                দেখুন</a>
                                        </td>
                                    </tr>
