 ...
 @section('member_content')
     ...
     <div class="col-lg-9 mt-4 mt-lg-0">
         <div class="dashboard-body">
             <div class="content-header" style="padding: 15px;">
                 আপনার নাগরিক সনদটি ডাউনলোড করতে <a style="cursor: pointer; color: red;" class="nagorik_pdf">এখানে
                     ক্লিক</a> করুন
             </div>
         </div>
                     ...
                     <div class="border-1">
                         <div class="border-2">
                             <div class="content">
                                     ...
                                     <div class="d-flex justify-content-between">
                                         ...
                                         <div class="center text-center">
                                             ...
                                             <div class="text">
                                                 ...
                                                 <div class="title">চারিত্রিক সনদ</div>
                                             </div>
                                         </div>
                                 ...
                                 <input type="hidden" name="verified_nagorik_id" class="verified_nagorik_id"
                                     value="{{ $serial_no }}">
                                 ...
                                 <div class="body">
                                     ...
                                     <div class="sub-heading-text text-justify mt-4">
                                         ...
                                         আমার কাছে পরিচিত। আমার জানামতে আমার জানামতে উনার বিরুদ্ধে কোনো রাষ্ট্র বিরোধী
                                         অভিযোগ নেই।
                                         <br><br>
                                         ...
                                         <tr>
                                             ...
                                             <td width="300" class="text-center">
                                                 ...
                                                 <div class="small">ইমেইলঃ <span
                                                         class="small">trishalpourosova@gmail.com</span></div>
                                             </td>
                                         </tr>
                                     </table>
                                         ...
                                         <tr>
                                             ...
                                             <td width="200" style="text-align: right;">
                                                 <div id="nagorik_qrcode">
                                                     <img class="qr-code"
                                                         src="{{ asset('certificate/images/svg/qr-code.svg') }}" alt="">
                                                 </div>
                                             </td>
                                         </tr>
                                     </table>
     ...
     <script>
         $(document).ready(function($) {
             ...
             $(document).on('click', '.nagorik_pdf', function(e) {
                 e.preventDefault();
                 var val = $('.container-certificate').html();
                 var opt = {
                     margin: .291,
                     filename: 'nagorik_certificate_' + js.AutoCode() + '.pdf',
                     image: {
                         type: 'jpeg',
                         quality: 0.98
                     },
